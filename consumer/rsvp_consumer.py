...
# Kafka Consumer
consumer = KafkaConsumer(bootstrap_servers="broker.kafka.l4lb.thisdcos.directory:9092")
consumer.subscribe(["rsvp-stream"])

# Custom Code Imports
from database import Rsvpstream # Cassandra Model
...
connection.setup(['10.0.3.4'], "meetup")
# create keyspace
# keyspace name, keyspace replication strategy, replication factor
create_keyspace('meetup', 'SimpleStrategy', 3)
